...
class ShapelySweep:
    ...
    def overlapping_graph_elements_cgal(
        ...
        overlapping_vertices = set(int(i) for i in self._vertices_within(seg, r))
    ...
    def overlapping_interval_cgal(
        ...
        if not len(edge_hits):
            ...
            # Endpoint spheres (vertex a, vertex b). Copied from CGAL_Sweep.
            ...
            # Cylinder side (perpendicular-distance interval ∩ projection-in-[0,1]).
