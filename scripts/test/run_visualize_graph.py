...
if __name__ == "__main__":
    ...
    parser.add_argument("-rmt","--road_map_types",type=str,nargs="+",default=["grid", "prm", "cdt"],help="Road map types to visualize (matches folders under sample/<road_type>/).",)
    ...
    parser.add_argument("-ar","--agent_radii",type=float, nargs='+', default=[0.0, 1.0], help="agent radius")
