...
python scripts/generate/run_target_gen.py -s benchmark/train/map32.0x32.0_resolution1.0/agents4_obst0.1 --num_samples 1000 --num_neighbors 13.0 --min_edge_len 1e-10 --max_edge_len 5+1e-10 --num_graph_samples 1 --road_map_type prm --target_space convolution_binary --generate_new_graph True --is_start_goal_discrete True --weighted_sampling True --samp_from_prob_map_ratio 0.5
'''
