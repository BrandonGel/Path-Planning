...
if __name__ == "__main__":
    ...
    parser.add_argument("-o","--nb_obstacles",type=float, default=0.025, help="numb  er of obstacles or obstacle density")
    ...
    parser.add_argument("-p","--nb_permutations",type=int, default=1, help="number of permutations")
    ...
    parser.add_argument("-ngs","--num_graph_samples",type=int, default=5, help="number of graph samples")
    ...
    print(f"nb_permutations_tries {nb_permutations_tries}")
    ...
    print(f"Phase 3: Labeling dataset for num_agents={nb_agents}, road_map_type={road_map_types}, agent_radius={agent_radius}")
    label_dataset(path, None, mapf_solver_name, road_map_type, 0.0, args.visualize, num_workers=num_workers)

    print(f"Phase 4: Generating target space for num_agents={nb_agents}, road_map_types={ args.road_map_types}, agent_radius={agent_radius}")
